...
<div class="detail-screen">
  ...
  <div class="commentField">
    <div>Hỏi đáp về <span class="product__name"><?php echo $productDetail[0]["product_name"]; ?></span></div>
    
    <textarea class="comment" rows="4" cols="50" placeholder="Nhập bình luận ở đây"></textarea>
    <button class="ask">Gửi câu hỏi</button>
  </div>
